...
<?php
	if($this->session->userdata('role')=="sa" || $this->session->userdata('role')=="ac" || $this->session->userdata('role')=="ad" || $this->session->userdata('role')=='dir'){
		...
		echo"<li class=\"\">".anchor('sop/tampil_by_unit/'.$this->session->userdata('kodeUnit'),'Data SOP')."</li>";
		echo"<li class=\"\">".anchor('sla/tampil_by_unit/'.$this->session->userdata('kodeUnit'),'Data SLA')."</li>";
