...
<link type="text/css" href="<?php echo base_url('asset/DataTables/extensions/Buttons/css/buttons.dataTables.min.css');?>" rel="stylesheet">
<script type="text/javascript" src="<?php echo base_url('asset/DataTables/extensions/TableTools/dataTables.tableTools.min.js');?>"></script>

<script type="text/javascript" src="<?php echo base_url('asset/DataTables/extensions/Buttons/js/dataTables.buttons.min.js')?>"></script>
<script type="text/javascript" src="<?php echo base_url('asset/DataTables/extensions/Buttons/js/buttons.flash.min.js')?>"></script>
<!--
<link type="text/css" href="<?php echo base_url('asset/DataTables/media/css/jquery.dataTables.min.css');?>" rel="stylesheet">
...
<script type="text/javascript" src="<?php echo base_url('asset/cloudfire/ajax/jszip.min.js')?>"></script>
<script type="text/javascript" src="<?php echo base_url('asset/rawgit/pdfmake/pdfmake.min.js')?>"></script>
<script type="text/javascript" src="<?php echo base_url('asset/rawgit/pdfmake/vfs_fonts.js')?>"></script>

<script type="text/javascript" src="<?php echo base_url('asset/DataTables/extensions/Buttons/js/buttons.html5.min.js')?>"></script>
<script type="text/javascript" src="<?php echo base_url('asset/DataTables/extensions/Buttons/js/buttons.print.min.js')?>"></script>
