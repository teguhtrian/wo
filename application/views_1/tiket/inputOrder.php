...
<?php echo form_open('tiket/orderBaru', array('onSubmit'=>'return valOrder()', 'name'=>'formInfo'))?>
...
<div class="panel-body">
	<div class="col-sm-12">
		...
		<h4><strong>Pilih Order</strong></h4>
				...
				<select class="form-control" id="wo" name="wo" onchange="tampilSla()">
					<option value="0">-- Pilih Work Order --</option>
				</select>
				<br><label>SLA/SPM (Standard Pelayanan Minimum) :</label><br>
				<select class="form-control" id="sla" name="sla">
					<option value="0">-- Pilih SLA/SPM --</option>
				</select>
			<br>
		</div>
		<div class="col-sm-6">
...
<div class="col-sm-12">
	<div class="col-sm-6">
	<h4><strong>Tujuan Order</strong></h4>
	<label>Unit * :</label><br>
	...
	<br>
<hr>
<h4><strong>Pilih Pegawai</strong></h4>
	<div id="peg-0">
		<label>Pegawai ke-1 :</label>
...
function tampilPeg1(){
	...
	$.ajax({
		url:"<?php echo base_url();?>tiket/pilihpeg/"+unit+"/"+dept+"",
		success: function(html){
			$("#kepala").html(html);
		},
		dataType:"html"
