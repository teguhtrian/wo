...
class Laporan extends MY_Controller{
	...
	public function cetakLogInOutPeriode(){
		...
		// $mpdf->setWatermarkImage('./asset/images/logo.png', 1, array(60,10), array(5,2));
		// $mpdf->showWatermarkImage = true;
		$html .= '<div style="font-size:12pt; font-weight:bold; text-align:center; margin-bottom:0px">REKAPITULASI ABSEN LOG IN/OUT WORK ORDER</div>';
		$html .= '<div style="font-size:10pt; font-weight:bold; text-align:center; margin-top:0px">TANGGAL '.date("d-m-Y",strtotime($date[0])).' s/d '.date("d-m-Y",strtotime($date[1])).'</div>
