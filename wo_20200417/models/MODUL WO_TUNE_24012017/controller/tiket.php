...
class Tiket extends MY_Controller{
	...
	public function getRecord(){
		...
		$columns = array(
		    array( 'db' => 'no_tiket', 'dt' => 0 ),
		    array( 'db' => 'dari',  'dt' => 1 ),
		    array( 'db' => 'subjek',   'dt' => 2 ),
		...
		require('asset/DataTables/examples/server_side/scripts/ssp.class.php');
