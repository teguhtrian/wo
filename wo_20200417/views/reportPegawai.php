<body>
	<h2><strong>Report Per Pegawai</strong></h2>
			...
			<div class="col-sm-12">
				<div class="row">
					<div class="col-sm-6">
						...
						<select class="form-control" <?php echo $this->session->userdata('role')=='sa'?'':'disabled'?> id="unit">
				...
				<div class="row">
					<div class="col-sm-6">
						...
						<select class="form-control" onchange="pilihPegawai()" id="departemen">
				...
				<br>
					<div class="col-sm-6">
						<input class="btn btn-default" type="button" class="btn btn-default" value="Lihat" onclick="tampilReportPegawai()" />
						<input class="btn btn-default" type="submit" class="btn btn-default" value="Print" onclick=""/>
					</div>						
				</div>	
			</div>
		</div>
...
<script type="text/javascript">
	...
	function tampilReportPegawai(){
		...
		$.ajax({
			url:"<?php echo base_url();?>report/reportByNipp/"+nipp+"",
			success: function(html){
				$("#report").html(html);
			},
			dataType:"html"
